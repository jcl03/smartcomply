...
export default async function EditFormPage({ 
  ...
  //check if the form already filled
  ...
  const hasAuditResponse = !!(audit && audit.length > 0);
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-4 mt-6">
                  <Link href={`/protected/compliance/${id}/forms/${formId}`}>
  ...
  return (
    <EditFormWrapper 
      hasAuditResponse={hasAuditResponse}
      redirectPath={`/protected/compliance/${id}/forms/`}
    >
      <DashboardLayout userProfile={currentUserProfile}>
        <div className="space-y-8">
          {/* Header Section */}
