      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 shadow-2xl rounded-2xl overflow-hidden bg-white dark:bg-slate-800/50">
        ...
        <div className="hidden md:flex flex-col justify-center p-12 bg-gradient-to-br from-sky-500 to-blue-600 text-white">
          ...
          <p className="text-center text-sky-100 mb-6">
            Quality & Safety Excellence. Streamline your compliance processes with our intuitive platform.
          </p>
          <div className="mt-4 p-6 bg-white/10 rounded-xl border border-white/20 shadow-inner">
            <h3 className="text-lg font-semibold mb-2 text-center">Our Vision</h3>
