...
CREATE TABLE IF NOT EXISTS public.audit (
  ...
  form_id BIGINT REFERENCES public.form(id) ON DELETE CASCADE,
  user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE,
  status TEXT NOT NULL DEFAULT 'draft',
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  last_edit_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  result TEXT CHECK (result IN ('pass', 'failed')) NULL,
...
-- Create trigger to update last_edit_at
...
DROP TRIGGER IF EXISTS update_audit_last_edit_at ON public.audit;
CREATE TRIGGER update_audit_last_edit_at
