...
interface ChecklistItem {
  ...
  type: 'document' | 'checkbox'; // Either document upload or checkbox options
  required: boolean;
  category?: string;
  options?: string[];
}
                  ...
                  >                    <div className="flex-shrink-0 mt-0.5">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <p className="text-sm font-medium">{item.name}</p>                        <span className={`px-1.5 py-0.5 text-xs rounded ${
                      ...
                      <div className="mt-2 p-2 bg-gray-50 rounded text-xs">                        {item.type === 'document' ? (
