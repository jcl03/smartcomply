      ...
      <div className="relative z-10">
        ...
        <header className="bg-white/90 backdrop-blur-md border-b border-sky-200 shadow-sm sticky top-0 z-50">
          ...
          <div className="hidden md:flex items-center flex-1 max-w-lg mx-8">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-full pl-10 pr-4 py-2 bg-sky-50/50 border border-sky-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            {/* Notifications */}
            <button className="p-2 text-sky-600 hover:text-sky-900 hover:bg-sky-100 rounded-lg transition-colors relative">
